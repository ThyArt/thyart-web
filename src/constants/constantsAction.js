...
export const OPEN_CREATE_NEWSLETTER = "OPEN_CREATE_NEWSLETTER";
export const OPEN_MODIFY_NEWSLETTER = "OPEN_MODIFY_NEWSLETTER";
export const RECEIVE_NEWSLETTER = "RECEIVE_NEWSLETTER";
export const RECEIVE_NEWSLETTERS = "RECEIVE_NEWSLETTERS";
export const RECEIVE_NEWSLETTERS_ERROR = "RECEIVE_NEWSLETTERS_ERROR";
export const REQUEST_NEWSLETTERS = "REQUEST_NEWSLETTERS";
export const SORT_NEWSLETTERS = "SORT_NEWSLETTERS";
export const RECEIVE_NEWSLETTERS_CUSTOMERS = 'RECEIVE_NEWSLETTERS_CUSTOMERS';
