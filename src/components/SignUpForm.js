...
import { FormControl, Alert, Button, FormGroup, ControlLabel, HelpBlock } from 'react-bootstrap'
...
class SignUpForm extends Component {
    ...
    signup = () => {
        ...
        {
            const tmp = { name: 'toto', email: this.state.mailValue, password: this.state.passValue };
            pingAPI();
