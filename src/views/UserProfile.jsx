      ...
      <Grid container spacing={3}>
        ...
        <Grid item md={1} sm={3} xs={4}>
          ...
          <Dialog
            ...
            aria-labelledby="form-dialog-prenom"
          >
            <DialogTitle id="form-dialog-prenom">Prénom</DialogTitle>
            <DialogContent>
              <DialogContentText>Veuillez entrer votre prénom</DialogContentText>
              <TextField
                autoFocus
                margin="dense"
                id="firstname"
      ...
      <Grid container spacing={3}>
        ...
        <Grid item md={1} sm={3} xs={4}>
          ...
          <Dialog
            ...
            aria-labelledby="form-dialog-nom"
          >
            <DialogTitle id="form-dialog-nom">Nom</DialogTitle>
            <DialogContent>
              <DialogContentText>Veuillez entrer votre nom</DialogContentText>
              <TextField autoFocus margin="dense" id="name" label="Nom" type="Name" fullWidth />
            </DialogContent>
            <DialogActions>
              <Button
                onClick={() => {
      ...
      <Grid container spacing={3}>
        ...
        <Grid item md={1} sm={3} xs={4}>
          ...
          <Dialog
            ...
            aria-labelledby="form-dialog-mail"
          >
            <DialogTitle id="form-dialog-mail">Email</DialogTitle>
            <DialogContent>
              <DialogContentText>Veuillez entrer votre adresse mail</DialogContentText>
              <TextField autoFocus margin="dense" id="mail" label="Email" type="mail" fullWidth />
            </DialogContent>
            <DialogActions>
              <Button
                onClick={() => {
      ...
      <Grid container spacing={3}>
        ...
        <Grid item md={1} sm={3} xs={4}>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText>Veuillez entrer votre nouveau mot de passe</DialogContentText>
              <TextField
                autoFocus
                margin="dense"
                id="password"
